        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-7">
              <h1 className="mb-4">Why choose our oils?</h1>
              <p className="text-muted fs-5">
                 Jayam Oils, we combine traditional oil extraction methods with modern quality standards to deliver pure, healthy, and natural cooking oils. Every drop is crafted with care to bring authentic taste and nutrition to your family's table.
              </p>
            </div>
